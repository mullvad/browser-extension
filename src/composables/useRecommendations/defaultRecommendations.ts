...
export const settings: Recommendation[] = [
  {
    ...
    homeUrl: 'https://mullvad.net/en/help/dns-over-https-and-dns-over-tls/#when-to-use',
    activated: false,
    ignored: false,
    ctaLabel: undefined,
  },
  {
    ...
    homeUrl: 'https://mullvad.net/en/help/dns-over-https-and-dns-over-tls/#how-to-use',
    activated: false,
    ignored: false,
    ctaLabel: undefined,
  },
  ...
  },
  {
    ...
    homeUrl: 'https://mullvad.net/en/help/dns-leaks/',
    activated: false,
    ignored: false,
    ctaLabel: undefined,
  },
