...
describe('ConnectionLocation.vue', function () {
  it('should render an Unknown location', () => {
    const wrapper = mount(ConnectionLocation, {
      global: { provide: { [ConnectionKey as symbol]: ref({}) } },
    });
  ...
  it('should render just a city', () => {
    const wrapper = mount(ConnectionLocation, {
      global: { provide: { [ConnectionKey as symbol]: ref({ city: 'Ulan Bator' }) } },
    });
  ...
  it('should render just a Country', () => {
    const wrapper = mount(ConnectionLocation, {
      global: { provide: { [ConnectionKey as symbol]: ref({ country: 'Mongolia' }) } },
    });
  ...
  it('should render both a City and a Country', () => {
    const wrapper = mount(ConnectionLocation, {
      global: {
        provide: { [ConnectionKey as symbol]: ref({ city: 'Ulan Bator', country: 'Mongolia' }) },
      },
    });
